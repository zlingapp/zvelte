<script lang="ts">
    ...
    import UiTextChannel from "src/components/guild/channel-list/UiTextChannel.svelte";
    ...
    import { currentGuildChannel, currentGuild, guilds } from "src/lib/stores";
    ...
    function autoSelectChannel(guild: Guild) {
        ...
        if (guild.channels?.length) {
            ...
            $currentGuildChannel = firstTextChannel || null;
        } else {
