<script lang="ts">
    ...
    import ButtonWithTick from "src/components/base/controls/ButtonWithTick.svelte";
    import IconUpload from "src/components/base/controls/IconUpload.svelte";
    import Modal from "src/components/base/Modal.svelte";
    import Tooltip from "src/components/base/Tooltip.svelte";
    import Avatar from "src/components/base/Avatar.svelte";
