<script lang="ts">
    ...
    import MessageAttachments from "src/components/text/message/attachments/MessageAttachments.svelte";
    ...
    async function onDelete() {
        ...
        if ($currentGuildChannel == null && $currentDmChannel != null) {
            dm = true;
            channelId = $currentDmChannel.id;
        } else {
            channelId = $currentGuildChannel!.id;
        }
