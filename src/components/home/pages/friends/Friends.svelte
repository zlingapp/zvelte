<script lang="ts">
    ...
    import FriendsTabRequests from "src/components/home/pages/friends/tabs/requests/FriendsTabRequests.svelte";
    import FriendsTabFriends from "src/components/home/pages/friends/tabs/friends/FriendsTabFriends.svelte";
...
<div class="friends-page">
    ...
    {#if filter != Filter.Pending}
        ...
        {:else if friends.length > 0}
            <FriendsTabFriends bind:friends onlineOnly={filter == Filter.Online} />
        {:else}
            <div class="center">
                <div>
